      ...
      <div className="relative z-10 bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 w-full max-w-md animate-fade-in">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-primary-500 to-accent-500 text-white py-3 rounded-xl font-semibold hover:shadow-lg hover:scale-[1.02] transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
          >
            {loading ? (
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-600">
            ...
            <Link to="/register" className="font-semibold text-primary-600 hover:text-accent-600 transition-colors">
              Create Account
            </Link>
          </p>
        </div>
